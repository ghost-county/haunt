# Security Patterns -- Detailed Code Examples

> Referenced by `gco-secure-coding/SKILL.md`. Contains full TypeScript and Python
> implementations for every security pattern in the skill.
