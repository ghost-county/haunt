...
- **[Financial Metrics (GAAP)](references/financial_metrics_gaap.md)** - Standard definitions for SaaS/startup metrics with GAAP-compliant calculations
- **[Formula Best Practices](references/formula_best_practices.md)** - Excel formula patterns, error handling, and maintainability guidelines
- **[Visualization Best Practices](references/visualization_best_practices.md)** - Chart types, formatting standards, and data presentation guidelines
