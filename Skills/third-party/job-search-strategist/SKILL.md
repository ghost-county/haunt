...
- **[Job Posting Analysis Flags](references/job-posting-flags.md)** - Red and green flags to identify in job postings, with interpretation guidance
- **[Templates and Examples](references/templates-and-examples.md)** - Self-diagnostic tools, outreach templates, and application examples
