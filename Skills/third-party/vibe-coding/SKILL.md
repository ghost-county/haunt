...
- **[Prompt Patterns](references/prompt-patterns.md)** - Effective prompting templates for different vibe coding scenarios
- **[Security Checklist](references/security-checklist.md)** - Security considerations and validation steps for vibe-coded applications
- **[Tool Comparison](references/tool-comparison.md)** - Detailed comparison of vibe coding tools with pros, cons, and use cases
