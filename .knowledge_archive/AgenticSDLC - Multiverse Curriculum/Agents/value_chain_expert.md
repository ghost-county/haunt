---
name: value_chain_expert
description: Business Analyst Agent for value chain analysis
tools: Read, Write, Edit, TodoWrite, Grep, Glob, mcp__agent_chat__*, mcp__agent_memory__*
model: sonnet
color: green
---
