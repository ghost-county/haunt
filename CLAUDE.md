...
**Archived (2026-01-06):**
- 65 total requirements archived to `.haunt/completed/`
- Latest: REQ-380 Haunt Manifest System
- Previous: Repository Cleanup Batch, Damage Control Hooks, Secrets Management
